...
var _form = __webpack_require__(/*! ./form */ "./components/form.jsx");
...
var Charts = function (_Component) {
  ...
  function Charts() {
    ...
    var _this = _possibleConstructorReturn(this, (Charts.__proto__ || Object.getPrototypeOf(Charts)).call(this));

    google.charts.load('current', { 'packages': ['corechart'] });

    _this.drawCharts = _this.drawCharts.bind(_this);
  ...
  _createClass(Charts, [{
    ...
    value: function divisionByAge() {
      ...
      var finalAges = sortable.reverse().slice(0, 10);
...
var _charts = __webpack_require__(/*! ./charts */ "./components/charts.jsx");
...
var Form = function (_Component) {
  ...
  function Form() {
    ...
    _this.fetchUserData = _this.fetchUserData.bind(_this);
  ...
  _createClass(Form, [{
    ...
    value: function updateInfo(event) {
      var searchQuery = JSON.parse(event.target.value);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h1',
              null,
              'Upload a JSON file containing random people'
            ),
            _react2.default.createElement('input', { type: 'file', name: 'file', id: 'file', className: 'inputfile', onChange: this.fileChangedHandler }),
            _react2.default.createElement(
              'label',
              { htmlFor: 'file' },
              'Choose a file'
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h1',
              null,
              'Paste your JSON object into this input'
            ),
            _react2.default.createElement('input', { onChange: this.updateInfo })
          ),
          _react2.default.createElement(
            'p',
            null,
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h1',
              null,
              'Enter the Number of Users you want to fetch randomly (max 5000)'
            ),
            _react2.default.createElement(
              'p',
              null,
              'Data pulled in from randomuser.me'
            ),
            _react2.default.createElement('input', { placeholder: 'Num of Users', id: 'myInput' }),
            _react2.default.createElement(
              'button',
              { onClick: this.fetchUserData },
              'See the data in charts'
            )
          )
        ),
        _react2.default.createElement(_charts2.default, { data: this.state.text })
      );
    }
  }]);
...
var _app = __webpack_require__(/*! ./components/app */ "./components/app.jsx");
